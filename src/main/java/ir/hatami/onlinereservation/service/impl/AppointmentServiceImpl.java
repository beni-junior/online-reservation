...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public List<AppointmentReadDto> load() {
        return this.appointmentRepository.findAll().stream().map(app -> {
            ...
            appointmentReadDto.setMeetingTime(app.getMeetingTime());
    ...
    public AppointmentReadDto load(UUID id) {
        ...
        AppointmentReadDto appointmentReadDto = new AppointmentReadDto();
        appointmentReadDto.setMeetingTime(appointment.getMeetingTime());
    ...
    public void create(AppointmentCreateDto createDto) {
        ...
        appointment.setDoctor(this.doctorRepository.findById(createDto.getDoctorId()).orElseThrow(() -> new RuntimeException("invalid.doctor.id")));
        appointment.setPatient(this.patientRepository.findById(createDto.getPatientId()).orElseThrow(() -> new RuntimeException("invalid.patient.id")));
        appointment.setMeetingTime(createDto.getMeetingTime());
    ...
    public void update(UUID id, AppointmentUpdateDto updateDto) {
        ...
        appointment.setMeetingTime(updateDto.getMeetingTime());
